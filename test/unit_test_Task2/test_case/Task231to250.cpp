...
bool UNIT_TEST_Task2::Task248() {
    ...
    bool format = result == "UnitList[count_vehicle=3;count_infantry=2;Infantry[infantryType=SPECIALFORCES,quantity=2,weight=5,pos=(3,4)],Vehicle[vehicleType=ARMOREDCAR,quantity=3,weight=10,pos=(1,2)]]";
...
bool UNIT_TEST_Task2::Task249() {
    ...
    ul.insert(veh);
    string result = ul.str();
    bool format = result == "UnitList[count_vehicle=3;count_infantry=0;Vehicle[vehicleType=ARMOREDCAR,quantity=3,weight=10,pos=(1,2)]]";
...
bool UNIT_TEST_Task2::Task250() {
    ...
    //! expect ----------------------------------
    string expect = "UnitList[count_vehicle=1;count_infantry=2;Infantry[infantryType=ANTIAIRCRAFTSQUAD,quantity=1,weight=1,pos=(0,0)],Infantry[infantryType=REGULARINFANTRY,quantity=1,weight=1,pos=(0,0)],Vehicle[vehicleType=MORTAR,quantity=1,weight=1,pos=(0,0)]]";
